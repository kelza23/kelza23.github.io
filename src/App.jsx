          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <div className="flex items-center space-x-4 text-slate-400">
                <a href={`https://linkedin.com/in/${profile.linkedin}`} target="_blank" rel="noreferrer" className="hover:text-blue-600 transition-colors p-2 hover:bg-blue-50 rounded-full" aria-label="LinkedIn Profile"><Linkedin className="w-5 h-5"/></a>
                <a href={`https://github.com/${profile.github}`} target="_blank" rel="noreferrer" className="hover:text-slate-900 transition-colors p-2 hover:bg-slate-100 rounded-full" aria-label="GitHub Profile"><Github className="w-5 h-5"/></a>
              </div>
            </div>
          </div>
        </div>
